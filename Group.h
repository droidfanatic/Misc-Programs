...
public:
	 ...
	 */
	const Drawable& operator[](size_t index)
	{
	 ...
	 */
	size_t push_back(const Drawable& drawable)
	{
...
private:
	 ...
	 */
	vector<reference_wrapper<const Drawable>> m_drawables;
};